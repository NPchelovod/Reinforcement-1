...
{
    internal class App_Panel_1_81_KR_Export
    {
        ...
        private static void FillPullDown(RibbonPanel ribbonPanel, PulldownButtonData data)
        {
            ...
            App_Helper_Button.AddButtonToPullDownButton(item, "Экспорт\nExcel", assemblyPath, "Reinforcement.ExportImport", "Позволяет импортировать или экспортировать\nданные спецификаций из/в Excel", OV1);
