...
namespace Reinforcement
{
    internal class App : IExternalApplication
    {
        ...
        public Result OnStartup(UIControlledApplication app)
        {
            ...
            CreateButton("Линия обрыва", "Линия обрыва", "Reinforcement.DrBreakLineCommand", Properties.Resources.ES_BreakLine,
                "Размещение линии обрыва", $"Имя семейства должно быть {DrBreakLineCommand.FamName}",
                panelSpds);

            RibbonItemData noteLine25mm = CreateButtonData("Выноска25", "Выноска25", "Reinforcement.NoteLineCommand25mm", Properties.Resources.NoteLine_2_5,
