...
namespace Reinforcement
{
    internal class App : IExternalApplication
    {
        ...
        public Result OnStartup(UIControlledApplication app)
        {
            ...
            App_Panel_1_2_KR_SPDS.KR_SPDS(panelSpds, "ЕС BIM");



            //2. PanelSketchReinf

            App_Panel_1_3_KR_SketchReinf.KR_SketchReinf(panelSketchReinf, "ЕС BIM");



            //3. PanelDetailReinf

            App_Panel_1_4_KR_DetailReinf.KR_DetailReinf(panelDetailReinf, "ЕС BIM");

            //4. PanelDrawing

            App_Panel_1_5_KR_Drawing.KR_Drawing(panelDrawing, "ЕС BIM");


            //5. PanelSelection

            App_Panel_1_6_KR_Selection.KR_Selection(panelSelection, "ЕС BIM");
            ...
            App_Panel_1_7_KR_SAPR.KR_SAPR(panelSAPR, "ЕС BIM");
            ...
            App_Panel_1_8_KR_to_OV.KR_to_OV(panelOV, "ЕС BIM");
